...
export default class extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("rootStandardSheet", rootStandardSheet, {frameWidth: 16, frameHeight: 64});
        this.load.spritesheet("rootBigSheet", rootBigSheet, {frameWidth: 16, frameHeight: 96});
