...
export default class extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("rootStandardSheet", rootStandardSheet, {frameWidth: 9, frameHeight: 176});
        this.load.spritesheet("rootBigSheet", rootBigSheet, {frameWidth: 9, frameHeight: 264});
